...
var renderReading = function(next) {
    ...
    console.log(reading);
    var subject = reading.subject;
    var hex = reading.hexagram;
...
$.get("/symbol/random", function(data) {
    console.log(data);
    data.forEach(function(symbol) {
        console.log("Symbol!");
        console.log(symbol);
        var symbolString = JSON.stringify(symbol);
        newQueue.push(readings.push(symbolString) - 1);
    })
